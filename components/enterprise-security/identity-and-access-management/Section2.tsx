      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-700">
            We provide end-to-end services to manage identities for your
            employees, partners, and customers, from onboarding to offboarding.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl lg:max-w-5xl">
          ...
          <dl className="mt-6 grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:gap-y-16">
