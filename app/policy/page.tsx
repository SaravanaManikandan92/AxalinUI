...
export const metadata: Metadata = {
  title: "Privacy Policy | by Axalin",
  description:
    "Stay informed about how we handle your data. Our privacy policy guarantees the security of your personal information. Learn more at Axalin.",
  alternates: {
    canonical: "/policy",
  },
  openGraph: {
    ...
    images: [
      {
        ...
        alt: "Stay informed about how we handle your data. Our privacy policy guarantees the security of your personal information. Learn more at Axalin.",
      },
    ],
  },
};
...
export default function Policy() {
  const schemaMarkup = {
    ...
    "@type": "WebPage",
    url: "https://axalingroup.com/policy",
    name: "Privacy Policy",
    description:
      "Privacy policy (“Policy”) explains our policy regarding the collection, use, disclosure and transfer of your information by Axalin or any of its affiliate(s) (“we” or “us” or “our”), which operates the website axalingroup.com. (the “Site”).",
  };
  ...
  return (
    <>
      ...
      <article className="prose mx-auto mt-6 mb-16 max-w-5xl px-4 text-justify text-gray-600 sm:px-6 lg:px-8">
        ...
        <h4 className="italic">Personal Data</h4>
        <p>
        ...
        <h4 className="italic">Usage Data</h4>
        ...
        <h4 className="italic">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h4 className="italic">Business Transactions</h4>
        <p>
        ...
        <h4 className="italic">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="italic">Other legal requirements</h4>
        <p>
