...
export const metadata: Metadata = {
  title: "Terms and Conditions | by Axalin",
  description:
    "Legal agreement between Axalin & users outlined in our Terms & Conditions. Includes privacy policies and user responsibilities.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    ...
    images: [
      {
        ...
        alt: "Legal agreement between Axalin & users outlined in our Terms & Conditions. Includes privacy policies and user responsibilities.",
      },
    ],
  },
};
...
export default function Terms() {
  const schemaMarkup = {
    ...
    "@type": "WebPage",
    url: "https://axalingroup.com/terms",
    name: "Terms and Conditions",
    description:
      "By accessing this website, we assume you accept these terms and conditions. Do not continue to use Axalin if you do not agree to take all the terms and conditions stated on this page.",
  };
  ...
  return (
    <>
      ...
      <div className="py-6 sm:py-12">
        <div className="mx-auto max-w-7xl px-4 pl-4 pr-8 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="text-center pt-6">Last updated: October 05, 2025</p>
        </div>
      </div>
      <article className="prose mx-auto mt-6 mb-16 max-w-5xl px-4 text-justify text-gray-600 sm:px-6 lg:px-8">
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Axalin Consultancy
            Services Pvt Ltd, #1, Nandanam, 5th Main Road, OMBR Layout,
            Bangalore.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Axalin, accessible from{" "}
            <a
              className="text-[#08549c] hover:text-[#086ac1]"
        ...
        <p>
          ...
          <a
            className="text-[#08549c] hover:text-[#086ac1]"
            href="https://axalingroup.com/policy"
          >
            Privacy Policy
          </a>{" "}
        ...
        <p>
          The Service is provided to You <strong>"AS IS"</strong> and{" "}
          <strong>"AS AVAILABLE"</strong> and with all faults and defects
        ...
        <p>
          ...
          express or implied: <strong>(i)</strong> as to the operation or
          availability of the Service, or the information, content, and
          materials or products included thereon; <strong>(ii)</strong> that the
          Service will be uninterrupted or error-free; <strong>(iii)</strong> as
          to the accuracy, reliability, or currency of any information or
          content provided through the Service; or <strong>(iv)</strong> that
        ...
        <p>
          You represent and warrant that <strong>(i)</strong> You are not
          ...
          as a "terrorist supporting" country, and <strong>(ii)</strong> You are
